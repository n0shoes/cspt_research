...
describe("fetchEvent", () => {
    ...
    describe("mergeResponseHeaders", () => {
        it("should merge headers from Headers object to H3Event", () => {
            ...
            expect(mockedVinxiHttp.appendResponseHeader).toHaveBeenCalledWith(mockH3Event, "content-type", "application/json");
            expect(mockedVinxiHttp.appendResponseHeader).toHaveBeenCalledWith(mockH3Event, "x-custom", "value");
        });
    });
    describe("ResponseStub", () => {
        ...
        describe("statusText", () => {
            ...
            it("should set statusText on H3Event", () => {
                ...
                expect(mockedVinxiHttp.setResponseStatus).toHaveBeenCalledWith(mockH3Event, 200, "Not Found");
            });
        });
    });
    describe("HeaderProxy", () => {
        ...
        describe("set", () => {
            it("should set header value", () => {
                ...
                expect(mockedVinxiHttp.setResponseHeader).toHaveBeenCalledWith(mockH3Event, "content-type", "application/json");
            });
        });
        describe("delete", () => {
            it("should remove header", () => {
                fetchEvent.response.headers.delete("content-type");
                expect(mockedVinxiHttp.removeResponseHeader).toHaveBeenCalledWith(mockH3Event, "content-type");
            });
        });
        describe("append", () => {
        ...
        describe("forEach", () => {
            it("should iterate over headers", () => {
                ...
                expect(callback).toHaveBeenCalledWith("application/json", "content-type", expect.any(Object));
