...
function makeChunk(dataStr, declaredBytes) {
...
const cases = [
    { name: "deserializeJSONStream", call: (r) => deserializeJSONStream(r) },
    { name: "deserializeJSStream", call: (r) => deserializeJSStream("server-fn:0", r) },
];
describe("Serialization negative testing (unhappy paths)", () => {
    ...
    const _unhandledRejectionHandler = (reason, promise) => {
