...
// Risk: CRITICAL — searchParams decoded + innerHTML renders arbitrary HTML
  ...
  return (
    <div style={{ padding: "2rem", fontFamily: "monospace", maxWidth: 700 }}>
      ...
      <div
        style={{
          background: "#1a1a1a",
          border: `1px solid ${isDangerous ? "#f44" : widget ? "#555" : "#333"}`,
          borderRadius: 6,
          padding: "1rem",
          marginBottom: "1rem",
        }}
